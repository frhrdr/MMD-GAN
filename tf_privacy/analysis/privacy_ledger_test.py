...
class PrivacyLedgerTest(tf.test.TestCase):
  ...
  def test_sum_query(self):
    ...
    query = privacy_ledger.QueryWithLedger(query, population_size, selection_probability)
  ...
  def test_nested_query(self):
    ...
    query1 = gaussian_query.GaussianAverageQuery(l2_norm_clip=4.0, sum_stddev=2.0, denominator=5.0)
    query2 = gaussian_query.GaussianAverageQuery(l2_norm_clip=5.0, sum_stddev=1.0, denominator=5.0)
